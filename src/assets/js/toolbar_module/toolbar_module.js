var toolbarModule = (function (jQuery) {
  function _renderNodeDetailsTemplate(elementToUse, data) {
    ...
    let elemTemplate = `
        <div class="box">
        <p class="title badge badge-info">Participant Details</p>
        <h6>Name : ${data.name}<br><span>Type : ${data.type}</span></h6>
        <h6>Gender : ${data.gender}<br><span>Tone : ${data.tone}</span></h6>
        </div>
      `;
